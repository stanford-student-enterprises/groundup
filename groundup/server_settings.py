...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.dirname(os.path.dirname(__file__)), 'databases/sqlite3.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '2%ye19x_!n0jb+waazuien%6=vb!%t=x9inh9xxd*5am(5(=5o'
